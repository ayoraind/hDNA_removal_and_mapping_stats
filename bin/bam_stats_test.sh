...
mapped_reads=$(samtools stats work/95/411dffbba3db73d9668ba2e824e356/${FILE}.alignment.sorted.bam |  grep ^SN | awk 'NR == 7 {print $4}')
unmapped_reads=$(samtools stats work/95/411dffbba3db73d9668ba2e824e356/${FILE}.alignment.sorted.bam |  grep ^SN | awk 'NR == 9 {print $4}')
total=$(samtools stats work/95/411dffbba3db73d9668ba2e824e356/${FILE}.alignment.sorted.bam |  grep ^SN | awk 'NR == 1 {print $5}')
